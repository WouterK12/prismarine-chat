...
class ChatMessage {
  ...
  parse() {
    ...
    if (typeof json.text === "string") {
      ...
      if (typeof json.with === "object") {
        if (!Array.isArray(json.with)) {
          throw new Error(
            "Expected with property to be an Array in ChatMessage"
          );
        }
    ...
    if (typeof json.extra === "object") {
      if (!Array.isArray(json.extra)) {
        throw new Error(
          "Expected extra property to be an Array in ChatMessage"
        );
      }
    ...
    if (typeof json.clickEvent === "object") {
      ...
      if (typeof this.clickEvent.action !== "string") {
        ...
        Array.prototype.indexOf &&
        supportedClick.indexOf(this.clickEvent.action) === -1
      ) {
        if (debug)
          console.warn(
            "ChatMessage parsed with unsupported clickEvent",
    ...
    if (typeof json.hoverEvent === "object") {
      ...
      if (typeof this.hoverEvent.action !== "string") {
        ...
        Array.prototype.indexOf &&
        supportedHover.indexOf(this.hoverEvent.action) === -1
      ) {
        if (debug)
          console.warn(
            "ChatMessage parsed with unsupported hoverEvent",
  ...
  getText(idx, lang = defaultLang) {
    ...
    if (this.text && idx === 0)
      return this.text.replace(/§[0-9a-flnmokr]/g, "");
    ...
    if (
      this.extra &&
      this.extra.length + (this.text ? 1 : this.with.length) > idx
    ) {
